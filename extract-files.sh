...
# Copyright (C) 2017 The paOS Project
#
...
TWRP_QSEECOMD="$PA_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/qseecomd
TWRP_GATEKEEPER_SERVICE="$PA_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/android.hardware.gatekeeper@1.0-service-qti
TWRP_KEYMASTER_SERVICE="$PA_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/android.hardware.keymaster@3.0-service-qti
...
DEVICE_ROOT="$PA_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/
